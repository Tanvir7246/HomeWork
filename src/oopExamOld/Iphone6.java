...
public class Iphone6 extends Iphone5 {
	...
	public void compass() {
		System.out.println(" Compass method from Iphone6 class.");
	};

	public int materials(int ramPrice, int cameraPrice) {
		int total = ramPrice + cameraPrice;
		System.out.println(" My ram & camera altogether cost me: " + total);
		return total;
	}
	...
	public int materials(int ramPrice, int cameraPrice, String ProcessorPrice) {
		...
		System.out.println(" My ram, camera and processor altogether cost me: " + total);
		return total;
	}

	final int materials(int ramPrice, int cameraPrice, String ProcessorPrice, int invoiceNumber) {
		int total = ramPrice + cameraPrice + Integer.parseInt(ProcessorPrice);
		System.out.println(" My ram, camera and processor altogether cost me: " + total + "My invoice number is: "
				+ invoiceNumber);
		return total;
